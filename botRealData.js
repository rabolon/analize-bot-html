...
// let date1 = new Date(2021, 4, 3, 12);
// let date2 = new Date(2021, 7, 1, 12);
let date2 = new Date();
...
const resultado = axios.get(urlBase + urlCommand)
  ...
  .then(function (response) {
    ...
    grafica(tick, times, pricePercent, operationsPercent);
...
function grafica(tick, times, price, operations) {
